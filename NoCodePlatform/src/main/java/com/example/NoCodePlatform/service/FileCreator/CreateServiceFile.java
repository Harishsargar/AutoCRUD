...
public class CreateServiceFile {
    ...
    public static void create(String entityName, List<AttributesDetails> attributes, List<RelationDetails> relationDetails){
        String serviceCode = ServiceGenerator.generate(entityName, attributes, relationDetails);
